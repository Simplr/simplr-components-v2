                    ...
                    analyzer.traverse({
                        enterElement: (element) => {
                            ...
                            for (const attr in element.attribs) {
                                ...
                                else if (((_a = rawValue.quotedValue) === null || _a === void 0 ? void 0 : _a.startsWith('"')) && ((_b = rawValue.value) === null || _b === void 0 ? void 0 : _b.includes('"'))) {
                                    context.report({
                                        loc: loc,
                                        messageId: 'doubleQuotes'
                                    });
                                }
                                else if (((_c = rawValue.quotedValue) === null || _c === void 0 ? void 0 : _c.startsWith("'")) && ((_d = rawValue.value) === null || _d === void 0 ? void 0 : _d.includes("'"))) {
                                    context.report({
                                        loc: loc,
